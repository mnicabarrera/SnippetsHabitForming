...
#ifndef SNIPPETHABITFORMING_SWIFT_H
#define SNIPPETHABITFORMING_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="SnippetHabitForming",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class UIApplication;
@class UIWindow;
SWIFT_CLASS("_TtC19SnippetHabitForming26OrientationLockAppDelegate")
@interface OrientationLockAppDelegate : NSObject <UIApplicationDelegate>
